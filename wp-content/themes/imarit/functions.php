...
if ( ! function_exists( 'imarit_setup' ) ) :
	...
	function imarit_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'imarit' ),
		) );
...
function imarit_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'imarit_content_width', 640 );
}
...
function imarit_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'imarit' ),
		'id'            => 'sidebar-1',
...
function imarit_scripts() {
	...
	wp_enqueue_script( 'imarit-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'imarit-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
